...
export const faqItems = [
  {
    question: "MT4是什么��",
    answer:
      "MT4 (MetaTrader 4) 是全球最流行的���汇交易平台，支持 EA 自动交易，提供图表分析与下单管理和一键交易等功��。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "是的，EA 需要 MT4 平台持续在线，我们会提供部署 VPS (虚拟专用服务器) 的教程，它可以让您的交易环境在云端 24/7 稳定运行，不受本��断网或断电影响。",
  },
  {
    question: "安装和设置过程复��吗？",
    answer:
      "非常简单。我们提供详细的中文图文���册和视频教程。通常只需 10-15 分钟即可完成设置。我们的技术团队也提供远程协助服务。",
  },
  {
    question: "购买后是否还有后续续费费用？",
    answer:
      "��有。您购买的是终身授权许可。所有未来的策略优化、参数更新和软件升级均对所有客户免费开放。",
  },
];
...
export const testimonials = [
  ...
  {
    quote: "在过去一年高波动极端行情下，EA的新闻过滤系统表现完美，成功规避了极端风险，这份稳定性在市场上非常��见。",
    author: "David Park",
    role: "Senior Trader",
  },
  {
    quote: "刚开始接触外汇非常��茫，感谢技术团队的一对一远程安装服务，非常有耐���，让我这种新手也能轻松上手。",
    author: "Olivia Kim",
  ...
  {
    quote: "对于其他EA，这个系统的回撤控制��实名不虚传，赚钱的感觉真好。",
    author: "Grace Huang",
