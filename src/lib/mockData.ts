...
export const faqItems = [
  ...
  {
    question: "为什么需要 24 小时联网运行？如何实现？",
    answer: "为了不错过任何跨时区的交易信号并确保订单平仓的安全，MT4交易终端必须保持持续在线。由于家庭电脑难以保证电力与网络的持久稳定，我们强烈建议并提供详尽的VPS（云端虚拟专用服务器）部署教程。这能确保EA实现100%全天候在线，并获得最低延迟市场连接延迟。"
  },
  {
