...
export const features: {
  ...
  },
  {
    icon: TrendingUp,
    title: "复利增长模式",
    description: "支持动态仓位管理，随账户余额增长自动调整手数，实现资本的指数级增长。",
  },
  {
    icon: Clock,
    title: "专业技术支持",
...
export const faqItems = [
  {
    ...
    answer:
      "EA (Expert Advisor) 是一种在 MetaTrader 平台上运行的自动��交易程序，它根据预设的逻辑自动执行买卖操作，消除了情绪干扰，实现 24 小时不间断交易。",
  },
  {
    question: "Euro Stable EA 的最低资金要求是多少？",
    answer:
      "对��标准账户，我们建议最低入金 1000 美元。如果您使用美分账户 (Cent Account)，最低 100 美元即可开始运行，以确保有足够的保证金应对市场波动。",
  },
  {
