...
export const features: {
...
}[] = [
  {
    icon: ShieldCheck,
    title: "超低回撤控制",
    description: "部署多重风控算法，严格控制单笔交易风险，确保账户回撤始终处于可控范围。",
  },
  {
    icon: Zap,
    title: "全自动智能交易",
  ...
  },
  {
    icon: Clock,
    title: "专业技术支持",
    description: "提供一对一远程安装指导与��略优化建议，确保每一位用户都能顺利开启交易。",
  },
  {
    icon: BarChart,
    title: "多品种对冲策略",
    description: "完美匹配 EURUSD, GBPUSD 等主流���币对，通过多品种分散投资降低系统性风险。",
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过���",
...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "对于标准账户，我们建议最低入金 1000 美元。如果您使用美分账户 (Cent Account)，最低 100 美元即可开始运行，以确保有足够的保证金���对市场波动。",
  },
  {
    question: "我需要一直保持电脑开启吗？",
    answer:
      "是的，EA 需要 MT4 平台持续在线。我们强烈建议使用 VPS (虚拟专用服务器)，它可以让您的交易环境在云端 24/7 稳定运行，不受本地断网��断电影响。",
  },
  {
    question: "安装和设置过程复杂吗？",
    answer:
...
export const testimonials = [
  ...
  {
    quote: "该系统的风控逻辑非常严��，尤其是在回撤管理上，展现了极高的专业水准，是长期资产配置的理想选择。",
    author: "Liu Ming",
    role: "专业投资人",
  },
  {
    quote: "在多次高波动极端行情中，EA的新闻过滤系统表现完美，��功规避了极端风险，这种稳定性在市面上非常罕见。",
    author: "Sun Li",
    role: "资深交易员",
  },
  {
  ...
  {
    quote: "多品种对冲策略让投资更加安全，���户曲线非常漂亮，强烈推荐给朋友。",
    author: "周先生",
    role: "金融分析师",
  },
  {
