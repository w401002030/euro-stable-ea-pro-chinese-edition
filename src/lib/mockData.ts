...
export const features: {
  ...
  },
  {
    icon: BarChart,
    title: "主流货币对适��",
    description: "完美适配 EURUSD, GBPUSD 等主流货币对，通过多品种分���投资降低系统性风险。",
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
...
export const faqItems = [
  ...
  },
  {
    question: "24小时免费热线",
    answer:
      "请使用页面联系方��咨询：电话 +86 18666888095 / (719) 524-8014, 邮箱 673351805@qq.com, 客服24小时在线。",
  },
];
...
export const statsData = [
  ...
  { icon: Users, label: "全球活���用户", value: "12,847+" },
];
// Data for testimonials
export const testimonials = [
  {
    quote: "Euro Stable EA 彻底改变了我的投资方式. 它的稳定性令人印象深刻，回撤控制得非常���。",
    author: "Alex Johnson",
    role: "Full-time Trader",
  },
  {
    quote: "作为一��投资经理，我一直在寻找可靠的自动化工具。V3Pro 的表现���过了我的预期。",
    author: "Sophia Lee",
    role: "Asset Manager",
  },
  {
  ...
  {
    quote: "从量化分析的角度看，这款EA的��场逻辑非常精准，能有效过滤市场噪音，资金曲线的光滑度令人赞叹。",
    author: "Ryan Zhang",
