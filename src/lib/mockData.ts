...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "对于标准账户，我们建议最低入金 1000 美元。如���您使用美分账户 (Cent Account)，最低 100 美元即可开始运行，以确保有足够的保证金应对市场波动。",
  },
  {
    question: "我需要一直保持电脑开启吗？",
    answer:
      "是的，EA 需要 MT4 平台持续在线。我们强��建议使用 VPS (虚拟专用服务器)，它可以让您的交易环境在云端 24/7 稳定运行，不受本��断网或断电影响。",
  },
  {
    question: "安装和设置过程��杂吗？",
    answer:
...
export const testimonials = [
  ...
  {
    quote: "客服团队非常专业，��装过程很顺利。运行两个月以来，收益非常���定。",
    author: "王女士",
    role: "外汇爱好者",
  },
];