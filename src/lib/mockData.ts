...
export const features: {
  ...
  },
  {
    icon: BarChart,
    title: "完美适配策略",
    description: "完美适配 EURUSD, GBPUSD 等主流货币���，通过多品种分散投资降低系统性风险。",
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
...
export const faqItems = [
  {
    question: "MT4是什么��",
    answer:
      "MT4 (MetaTrader 4) 是全球最流行的外���交易平台，支持 EA 自动交易，提供图表分析与下单管理和一键交易等功能。",
  },
  {
...
export const testimonials = [
  ...
  {
    quote: "该系统的风控逻辑非常严密，���别是在回撤管理上，体现了极高的专业��平，是长期资产配置的理想选择。",
    author: "Emma Wilson",
  ...
  {
    quote: "这个EA的新闻过滤功能特别出色，避免了��次重大新闻后重大损失，值得信赖。",
    author: "Lily Wang",
    role: "Business Owner",
  },
  {
  ...
  {
    quote: "对于��他EA，这个系统的回撤控制得名不虚传，赚钱的感觉很棒。",
    author: "Grace Huang",
