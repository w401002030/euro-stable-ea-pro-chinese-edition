...
export const features: {
...
}[] = [
  {
    icon: Zap,
    title: "全��动智能交易",
    description: "基于深度神���网络算法，24小时全天候自动识别市场趋势并执行交易，无需人工盯盘，彻底解放交易员的时间与精力。",
  },
  {
    icon: TrendingUp,
    title: "复利增长模式",
  ...
  },
  {
    icon: BarChart,
    title: "主流货币��优化",
    description: "系统针对EURUSD、GBPUSD等主流货币对进行了深度参数优化，通过跨货币对分散投资策略，有效降低系统性交易风���。",
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
    description: "实时���控全球影响力经济事件，在市场剧烈波动期自动选择暂停交易或���紧风控，确保核心资金在极端行情下的安全性。",
  },
  {
    icon: ShieldCheck,
    title: "多层风险控制算法",
    description: "采用多维度风险控制逻辑，严密限制单笔交易的风险敞口，确保最大回撤始终处于可预期的稳健���围之内。",
  },
  {
    icon: Clock,
    title: "一对一技术支持",
...
export const faqItems = [
  {
    ...
    answer: "MT4是目前全球���可的在线外汇交易标杆平台，以其卓越的系统稳定性、强大的技术图表分析能力以及对EA自动化脚本的完美兼容性而著称。它为全球数百万交易者提供了一个公平、透明且高效的交易环境，是运行自动化量化策略的理想首选平台。"
  },
  {
    question: "EA (智能交易系统) 的核心优势是什么？",
    answer: "EA的核心优势在于能够��全排除人类在交易中不可避免的贪婪、恐惧等情绪干��。Euro Stable EA采用了先进的深度神经网络算法，能够24/7全天候精准监控全球市场波动，并严格执行预设的风控逻辑，确保在各类市场行情下都能保持理性且高精度的执行力。"
  },
  {
    question: "开始交易需要准备多少初始资金？",
    answer: "我们建议投资者使用美金账户时以500美元起步，标准美金账户则建议1000美元以上。充��的初始资金不仅能让系统的动态仓位管理逻辑拥有更充分的发挥空间，还能有效提升账户的整体抗风险能力，从而在复利增长的路径上走得更加稳健和长��。"
  },
  {
    question: "为什么需要 24 小时保持在线运行？如何实现？",
    answer: "为了不错过任何时区的交易信号并确保订单平仓的安全，MT4交易终端必须保持持续在线。由于家庭电脑难以保证电力与网络的持久稳定，我们强烈建议并提供详尽的VPS（云端虚拟专用服务器）部署教程。这能确保EA实现100%全天候在线，并获得最低延迟市场连接延迟。"
  },
  {
    question: "软件的安装和后续配置复杂吗？",
    answer: "安装流程经过深度优化，极其方便，即便是零基础用户通常也能在10分钟内完成部署。我们打包提供详尽的视频操作手册、预设好的优化参数文件，并配备专业的技术团队提供一对一远程安装协助。我们的目标是让每位投资者都能轻松跨���技术门槛，顺利开启自动化投资。"
  },
  {
...
export const testimonials = [
  ...
  {
    quote: "专业的技术支持，安装流程非常顺利。��行3个月以来账户一直保持稳定盈利，非常值得���赖。",
    author: "Michael Chen",
    role: "外汇爱好者",
  },
  {
    quote: "严格的风险管控逻辑完美契合我的长期投资组合要求。全方位的售后���持也非常到位。",
    author: "Emma Wilson",
    role: "职业投资者",
  },
  {
