...
export const features: {
  ...
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
    description: "实时监控���影响力经济事件，在市场剧烈波动期自动选择暂停交易或收紧风控，确保核心���金在极端行情下的安全性。",
  },
  {
    icon: ShieldCheck,
    title: "多层风险算法",
...
export const faqItems = [
  ...
  {
    question: "���始交易需要准备多少初始资金？",
    answer: "我们建议投资者使用美分账户时以500美元起步，标准美金账户则建议1000美元以上。充足的初始资金不仅能让系统的动态仓位管理逻辑拥有更充裕的发挥空间，还能有效提升账户的整体抗风险能力，从而在复利增长的路径上走得更��稳健和长远。"
  },
  {
    question: "为什么需要 24 小时开机运行？如何实现？",
    answer: "为了不错过任何跨时区的交易信号并确保订单平仓的安全，MT4交易终端必须保持持续在线。由于家庭电脑难以保证电力和网络的长久稳定，我们强烈建议并提供详尽的VPS（云端虚拟专用服务器）部署教程。这能确保EA实现100%全天候在线，并获得极低的市场连接延迟。"
  },
  {
...
export const testimonials = [
  ...
  {
    quote: "作为一名资产管理经理，V3 Pro 表现出的可靠性��超预期，收益曲线在剧烈波动的市场中依然平滑。",
    author: "Sophia Lee",
    role: "资管经理",
  },
  {
  ...
  {
    quote: "技术团队非常有耐心，即使我是新手也能在指导下轻松上手。账户目前的��利曲线非常优美。",
    author: "Olivia Kim",
    role: "新手投资者",
  },
  {
    quote: "精准的量化逻辑，过���一年间实现了资产的持续增长。遇到技术问题反馈和解决的速度极快。",
    author: "Ryan Zhang",
    role: "机构分析师",
  },
  {
    quote: "对冲策略���来了极大的安心，顶级回撤控制。我会把这款软件推荐给所有追求稳健收益的零售投资者。",
