...
export const faqItems = [
  {
    ...
    answer:
      "EA (Expert Advisor) 是一种在 MetaTrader ��台上运行的全自动交易程序，它根据预设的逻辑自动执行买卖操作，消除了情绪干扰，实现 24 小时不间断交易。",
  },
  {
    question: "Euro Stable EA 的最低资金要求是多少？",
    answer:
      "对于标准账户，我们建议最低入金 1000 美元. 如��您使用美分账户 (Cent Account)，最低 500 美元即可开始运行，并确保���足够保证金应对市场波动。",
  },
  {
    question: "我需要一直保持���脑开启吗？",
    answer:
      "是的，EA 需要 MT4 平台持续在线，但我们会提供部署 VPS (虚拟专用服务器)的教程，它可以让您的交易环境在云端 24/7 稳��运行，不受本地断网或断电影响。",
  },
  {
    question: "安装和设置过程��杂吗？",
    answer:
      "非常简单。我们提供详细的中文图文手册和视频教程。通常只需 10-15 分钟即可完成设置。我们的技术���队也提供远程协助服务。",
  },
  {
  ...
  },
  {
    question: "MT4是什么？",
    answer:
      "MT4 (MetaTrader 4) 是全球最流行的外汇交易平台，支持EA自动交易，提供图表分析、订单管理和一键交易等��能。",
  },
];
...
export const testimonials = [
  ...
  {
    quote: "作为一名投资经���，我一直在寻找可靠的自动化工具。V3Pro 的表现超过了我的预期。",
    author: "Sophia Lee",
    role: "Asset Manager",
  },
  {
  ...
  {
    quote: "该系统的风控逻辑非常严密，���别是在回撤管理上，体现了极高的专业水��，是长期资产配置的理想选择。",
    author: "Emma Wilson",
    role: "Professional Investor",
  },
  {
    quote: "在近一年高波动极端行情下，EA的新闻过滤系统表现完美，成功规避了极端风险，这种稳定性在市面上非常罕见。",
    author: "David Park",
    role: "Senior Trader",
  },
  {
  ...
  {
    quote: "从量化分析的��度看，这款EA的入场逻辑非常精准，能��效过滤市场噪音，资金曲线的光滑度令人惊叹。",
    author: "Ryan Zhang",
    role: "Institutional Analyst",
  },
  {
    quote: "这个EA的新闻过滤功能特别出色，��免了多次重大新闻后大损失，值得信赖。",
    author: "Lily Wang",
    role: "Business Owner",
  },
  {
