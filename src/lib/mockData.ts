...
export const features: {
...
}[] = [
  {
    icon: ShieldCheck,
    title: "极低回撤",
    description: "先进的风险管理���统，确保资金回撤控制在最低水平，保护您的资本安全。",
  },
  {
    icon: Zap,
    title: "全自动策略",
    description: "无需人工干预，EA 24/7 自动执��交易，抓住每一个市场机会。",
  },
  {
    icon: TrendingUp,
    title: "稳定盈利曲线",
    description: "经过多年市场数据回测与实盘���证，展现出持续稳定的盈利能力。",
  },
  {
    icon: Clock,
    title: "24/7 技术支持",
    description: "��们的专业团队随时为您服务，��答您遇到的任何问题。",
  },
  {
    icon: BarChart,
    title: "多货币对支持",
  ...
  },
  {
    icon: LifeBuoy,
    title: "终身免费更新",
    description: "���次购买，即可享受所有后续策略优化与软件版本更新。",
  },
];
...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "我们建���最低入金为 1000 美元，以确保 EA 能够在安全的风险水平���有效运行。更低的资金也可以运行，但风险会相应增加。",
  },
  {
    question: "我需要一直开着��脑吗？",
    answer:
  ...
  },
  {
    ...
    answer:
      "没有。您购买的是终身许可证，所有未来的软件更新和策略优化���是免费的，没有任何隐藏费用或订阅费。",
  },
];
...
export const testimonials = [
  {
    quote: "Euro Stable EA 彻底改变��我的交易生涯。稳定盈利，低回撤，完美！",
    author: "张���",
    role: "全职交易员",
  },
  {
    quote: "安装简单，运行稳定。���个月收益超过预期，强烈推荐！",
    author: "王芳",
    role: "投资经��",
  },
  {
