...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "对于标准账户，���们建议最低入金 1000 美元. 如果您使用美分账户 (Cent Account)，最低 100 美元即可开始运行，以确保有足够的保证金应对市场波动。",
  },
  {
...
// Data for testimonials - Updated with Western identities and English roles
export const testimonials = [
  ...
  {
    quote: "作为一名投资经理，我一直在寻找可靠的自动化工具。V3Pro 的表现超���了我的预期。",
    author: "Sophia Lee",
    role: "Asset Manager",
  },
  {
    quote: "客服团队非常专业，安装过程很顺利。运行两个月以来，收���非常稳定。",
    author: "Michael Chen",
    role: "Forex Enthusiast",
  },
  {
    quote: "该系统的���控逻辑非常严密，尤其是在回撤管理上，展现了极高���专业水平，是长期资产配置的理想选择。",
    author: "Emma Wilson",
