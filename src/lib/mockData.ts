...
export const features: {
  ...
  },
  {
    icon: Zap,
    title: "全自动智��交易",
    description: "基于神经网络算法，24/7 自动���别市场趋势并执行交易，无需人工盯盘。",
  },
  {
    icon: TrendingUp,
    title: "复利增长模式",
...
export const faqItems = [
  ...
  },
  {
    question: "安装和设置过程复杂吗？",
    answer:
      "非常简单。我们提供详细的中文图文手册和视频教程。��常只需 10-15 分钟即可完成设置。我们的技术团队也提供远程协助服务。",
  },
  {
...
export const testimonials = [
  ...
  {
    quote: "从量化��析的角度看，这款EA的入场逻辑非常精��，能有效过滤市场噪音，资金曲线的平滑度令人惊叹。",
    author: "Chen Xia",
    role: "机构分析师",
  },
  {
