...
export const features: {
  ...
  },
  {
    icon: TrendingUp,
    title: "复利增长���式",
    description: "设置动态仓位管���系统，根据账户净值的实时增长自动调整下单手数，科学实现资金的指数级复利增长效应。",
  },
  {
    icon: BarChart,
    title: "主流货币对优化",
    description: "系统针对EURUSD、GBPUSD等主流货币对进行了深度参数优化，通过跨货币对��散投资策略，有效降低系统性交易风险。",
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
...
export const faqItems = [
  {
    question: "��么是 MT4 (MetaTrader 4) 平台���",
  ...
  },
  {
    ...
    answer: "我们建议新手投资者使用美分账户时以500美元（即50000美���）起步，标准美金账户则建议1000美元以上。充足的初始资金不仅能让系统的动态仓位管理逻辑拥有更充分的发挥空间，���能有效提升账户的整体抗风险能力，从而在复利增长的路径上走得更加稳健和长远。"
  },
  {
    question: "为什么需要 24 小时保持在线运行？如何实现？",
    answer: "为了不错过任何时区的交易信号并确保订单平仓的安全，MT4交易终端必须保持持续在线。由于家庭电脑难以保证电力与网络的持久稳定，我们强烈建议并提供详尽的VPS（云端虚拟专用服务器）部署教程。这能确保EA实现100%全天候在线，并获得最低延迟市场��接延迟。"
  },
  {
    question: "软件的安装和后续配置复杂吗？",
    answer: "安装流程经过深度优化，极其方便，即便是��基础用户通常也能在10分钟内完成部署。我们打包提供详尽的视频操作手册、预设��的优化参数文件，并配备专业的技术团队提供一对一远程安装协助。我们的目标是让每位投资者都能轻松跨越技术门槛，顺利开启自动化投资。"
  },
  {
    question: "购买后需要支付后续续费或订阅费吗？",
    answer: "Euro Stable EA 采用一次性付费、终身授权的商业模式。购买后您将获得永久使用权限，没有任何隐性���阅成本或后续续费要求。此外，我们承诺为所有授权用户提供终身免费的策略优化更新与算法升级支持，确保您的系统能够持续适应不断变化的市场环境。"
  },
  {
    question: "我该如何开设交易账户？",
    answer: "您可以选择全球受监管的知名经纪商开设MT4/ECN账户。基本流程包括：在线注册、上传证件进行KYC身份验证、通过电��或第三方支付入金。为了让EA发挥最佳性能，我们强烈建议选择低点差、低延迟的交易环境。如您在开户过程中遇到困难，请随时联系我们的客服团队，我们将全程协助您完成开户���资金部署。"
  }
];
export const statsData = [
  { icon: TrendingUp, label: "历史胜���", value: "85.3%" },
...
export const testimonials = [
  {
    quote: "Euro Stable EA 彻底改变了我的投资方式，其稳定性和���撤控制能力在同类产品中令人印象深刻。",
    author: "Alex Johnson",
    role: "全职交易员",
  },
  {
  ...
  {
    quote: "内置的新闻过滤���完美应对了非农期的市场剧烈波动，帮助我成功规��了多次风险行情，信心倍增。",
    author: "David Park",
    role: "资深交易员",
  },
  {
