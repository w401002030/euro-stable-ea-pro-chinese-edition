...
export const features: {
...
}[] = [
  {
    icon: ShieldCheck,
    title: "��低回撤控制",
    description: "��置多重风控算法，严格控制单笔交易风险，确保账户回撤始终处于��控范围。",
  },
  {
    icon: Zap,
    title: "全自动智能交易",
    description: "基于神经网络算法，24/7 自动识别市场趋势并执行交易，无���人工盯盘。",
  },
  {
    icon: TrendingUp,
    title: "复利增长模式",
    description: "支持动态仓位管理，随账户余额增长自动调整手数，实现���本的指数级增长。",
  },
  {
    icon: Clock,
    title: "专业技术支持",
  ...
  },
  {
    icon: BarChart,
    title: "多品种对冲策略",
    description: "完���匹配 EURUSD, GBPUSD 等主流货币对，通过多品种分散投资降低系统性风险。",
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "对于标准账户，我们建议最低入金 1000 美元。如果您使用美分账户 (Cent Account)，最低 100 美元��可开始运行，以确保有足够的保证金应对市场波动。",
  },
  {
  ...
  },
  {
    question: "安装和设置过程��杂吗？",
    answer:
      "非常简单。我们提供详���的中文图文手册和视频教程。通常只需 10-15 分钟即可完成设置。我们的���术团队也提供远程协助服务。",
  },
  {
