...
export const faqItems = [
  {
    ...
    answer:
      "EA (Expert Advisor) 是一种在 MetaTrader 平台上运行的全自动交易程序，它根据预��的逻辑自动执行买卖操作，消除了情绪干扰，实现 24 小时不间断交易。",
  },
  {
    question: "Euro Stable EA 的最低资金要求是多少？",
    answer:
      "对于标准账户，���们建议最低入金 1000 美元. 如果您使用美分账户 (Cent Account)，最低 500 美元即可开始运行，并确保有足够保证金应对市场波动。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "没有。您购买的是终身���权许可。所有未来的策略优化、参数更新和软件升级均对��有客户免费开放。",
  },
];
...
export const testimonials = [
  ...
  {
    quote: "在��年高波动极端行情中，EA的新闻过滤系统表现完美，成功规避了极端风险，这种稳定性在市面上非常罕见。",
    author: "David Park",
    role: "Senior Trader",
  },
  {
  ...
  {
    quote: "从量化分析的角度看，这款EA的入场逻辑非常精准，能��效过滤市场噪音，资金曲线的平滑度令人惊叹。",
    author: "Ryan Zhang",
