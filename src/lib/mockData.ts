...
export const features: {
...
}[] = [
  {
    icon: ShieldCheck,
    title: "极���回撤",
    description: "先进的��险管理系统，确保资金回撤控制在最低水平，保护您的资本安全。",
  },
  {
    icon: Zap,
    title: "全自动策略",
  ...
  },
  {
    icon: BarChart,
    title: "多货币对支持",
    description: "���化支持 EURUSD, GBPUSD, USDJPY 等主流货币对，分散风险。",
  },
  {
    icon: LifeBuoy,
    title: "终身免费更新",
...
export const faqItems = [
  {
    ...
    answer:
      "EA (Expert Advisor) 是一���在 MetaTrader 平台上运行的自动化交易程序。它根据设定的交易策略自动执行买卖操作，���需人工干预。",
  },
  {
  ...
  },
  {
    question: "我需要一直开着电脑吗？",
    answer:
      "是的，为了让 EA 能够 24/5 不间断运行，您的交易平台需要保持在线。我们强烈建议您使用 VPS (虚拟专用服务器) 来托管您的交易账户，这样可以保证稳定性和���接性。",
  },
  {
    question: "安装和设置过程复杂吗？",
    answer:
...
export const testimonials = [
  {
    quote: "Euro Stable EA 彻底���变了我的交易生涯。稳定盈利，低回撤，完美��",
    author: "Zhang Wei",
    role: "Full-time Trader",
  },
  {
    quote: "安装简单，运行稳定。每个月收益超过预期，强烈推荐！",
    author: "Wang Fang",
