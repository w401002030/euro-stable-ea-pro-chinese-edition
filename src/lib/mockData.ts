...
export const features: {
...
}[] = [
  {
    icon: Zap,
    title: "全��动智能交易",
    description: "基于深度��经网络算法，24小时全天候自动识别市场趋势并执行交易，无需人工盯盘��",
  },
  {
    icon: TrendingUp,
    title: "复利增长模式",
  ...
  },
  {
    icon: BarChart,
    title: "主流货币对适配",
    description: "完美适配 EURUSD, GBPUSD 等主流货币对，通过多品种分散投资降���系统性风险。",
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
  ...
  },
  {
    icon: Clock,
    title: "专业技术支持",
    description: "提供一对一远程安装指南与策略优化��议，确保每一位用户都能顺利开启交易。",
  },
];
...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "EA (Expert Advisor) 是一种��� MetaTrader 平台上运行的全自动交易程序，它根据预设的逻辑自动执行买卖操���，消除交易情绪干扰，实现 24 小时不间断交易。",
  },
  {
    question: "Euro Stable EA 的最低资金��求是多少？",
    answer:
      "对于标准账户，我们建议最低资金 1000 美元 (美金账户)。如果您使用美分账户 (Cent Account)，最低 500 美元即可开始运行，并确保有足够保证金应对市场波动。",
  },
  {
  ...
  },
  {
    question: "安装和设置过程复杂吗？",
    answer:
      "非常简单。我们提供���细的中文图文手册和视频教程。通常只需 10-15 分���即可完成设置。我们的技术团队也提供远程协助服务。",
  },
  {
...
export const testimonials = [
  ...
  {
    quote: "���为一位投资经理，我一直在寻找可靠的自动化工具。V3Pro 的表现超出了我的预期。",
    author: "Sophia Lee",
    role: "Asset Manager",
  },
  {
    quote: "客服团队非常专业，安装过程很顺利。运行三个���以来，收益非常稳定。",
    author: "Michael Chen",
  ...
  {
    quote: "在过去一年高波动极端行情下，EA的新闻过滤系统表现完美，成功规避了极端风险，这份稳定性在���场上非常出色。",
    author: "David Park",
    role: "Senior Trader",
  },
  {
  ...
  {
    quote: "从量化分析的角度看，这款EA的捕捉市场逻辑非常精确，能有效过滤市场噪音，资金曲线的光滑度令人赞叹。",
    author: "Ryan Zhang",
