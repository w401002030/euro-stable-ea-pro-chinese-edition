...
export const faqItems = [
  ...
  },
  {
    question: "MT4是什么？",
    answer:
      "MT4 (MetaTrader 4) 是全���最流行的外汇交易平台，支持 EA 自动交易，提供图表分析、订单管理和一键交易等功能。",
  },
];
...
export const testimonials = [
  {
    quote: "Euro Stable EA 彻��改变了我的投资方式。它的稳定性令人���象深刻，回撤控制得非常好。",
    author: "Alex Johnson",
  ...
  {
    quote: "在近一年高波动极端行情下，EA的新闻过滤系统表现完美，成功规避了极端风险，这种稳定性在市面上非常���见。",
    author: "David Park",
    role: "Senior Trader",
  },
  {
    quote: "刚开始接触外汇非常迷茫，感谢技术团队的一对一远程安装服务，非常有耐���，让我这种新手也能轻松上手。",
    author: "Olivia Kim",
  ...
  {
    quote: "这个EA的新闻过滤功能特别出色，避免了多次重大新闻后的大损失，值得信赖。",
    author: "Lily Wang",
    role: "Business Owner",
  },
  {
