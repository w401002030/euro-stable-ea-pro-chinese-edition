...
export const features: {
  ...
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
    description: "实时监控全球影响力经济事件，在市场剧烈波动期自动选择暂停交易或收紧风控，确保核心资金在极端行情下的安全性。",
  },
  {
    icon: ShieldCheck,
    title: "多层风险控制算法",
...
export const faqItems = [
  ...
  },
  {
    ...
    answer: "为了不错过任何跨时区的交易信号并确保订单平仓的安全，MT4交易终端必须保持持续在线。由于家庭电脑难以保证电力与网络的长久稳定，我们强烈建议并提供详尽的VPS（云端虚拟专用服务器）部署教程。这能确保EA实现100%全天候在线，并获得最低延迟市场连接延迟。"
  },
  {
