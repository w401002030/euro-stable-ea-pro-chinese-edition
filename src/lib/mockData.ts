...
export const features: {
  ...
  },
  {
    icon: BarChart,
    title: "完美适配策略",
    description: "完美适配 EURUSD, GBPUSD 等主流货币对，���过多品种分散投资降低系统性风险。",
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
    description: "自动识别重大影响财经数据发布时间，在极��波动行情前自动规避，保护本金安全。",
  },
  {
    icon: ShieldCheck,
    title: "超低回撤��制",
    description: "部署多重风控算法，严格控制��笔交易风险，确保账户回撤始终处于可控范围。",
  },
  {
    icon: Clock,
    title: "专业技术支持",
...
export const faqItems = [
  {
    question: "MT4是什么？",
    answer:
      "MT4 (MetaTrader 4) 是全球最流行的外汇交易平���，支持 EA 自动交易，提供图表分析与下单管理和一键交易等功能。",
  },
  {
...
export const testimonials = [
  ...
  {
    quote: "刚开始接触外汇非常迷���，感谢技术团队的一对一远程安装服务，非常有耐心，让我这种新手也能轻松上手。",
    author: "Olivia Kim",
    role: "Novice Investor",
  },
  {
    quote: "从量化分析的角度看，这款EA的入场逻辑非常精准，能有效过滤市场噪音，资金曲线的光滑度令人赞叹。",
    author: "Ryan Zhang",
  ...
  {
    quote: "从安装到运行全程支持到��，策略参数也很适合小资金用户，收益很可观。",
    author: "Ethan Liu",
    role: "Retail Investor",
  },
  {
    quote: "对于其他EA，这个系统的回撤控制得名不虚传，赚钱的感觉很棒。",
    author: "Grace Huang",
  ...
  {
    quote: "���品种对冲策略让投资更加安全，资金曲线非常漂亮，强烈推荐给朋友。",
