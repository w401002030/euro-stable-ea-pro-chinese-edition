...
export const faqItems = [
  {
    ...
    answer:
      "EA (Expert Advisor) 是一种在 MetaTrader 平台上运行的全自动交易程序，它根据预设的逻辑自动执行买卖操作，消除了情绪干扰，实现 24 小��不间断交易。",
  },
  {
    question: "Euro Stable EA 的最低资金要求是多少？",
    answer:
      "对于标准账户，我们建议最低入金 1000 美元。如果您���用美分账户 (Cent Account)，最低 500 美元即可开始运行，并确保��足够保证金应对市场波动。",
  },
  {
    question: "我需要一直保持电脑开启吗？",
    answer:
      "是的，EA 需要 MT4 平台持续在线，但我们会提供部署 VPS (虚拟专用服务器)的教程，它可以让您的交易环境在云端 24/7 稳定运行，不受本���断网或断电影响。",
  },
  {
    question: "安装和设置过程复��吗？",
    answer:
...
export const statsData = [
  ...
  { icon: Users, label: "全球���跃用户", value: "12,847+" },
];
...
export const testimonials = [
  ...
  {
    quote: "该系统的风控逻辑非常严密，尤其是在回撤管理上，体现了极高的��业水平，是长期资产配置的理想选择。",
    author: "Emma Wilson",
  ...
  {
    quote: "从量化分析的角度看，这款EA的入场逻辑非常精��，能有效过滤市场噪音，资金曲线的平滑度令人惊叹。",
    author: "Ryan Zhang",
  ...
  {
    quote: "多品种对冲策略让投资更加安全，资金曲线非常漂亮，强烈推荐给朋��。",
