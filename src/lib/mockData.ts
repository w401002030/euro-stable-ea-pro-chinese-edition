...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "对于标准账户，我们建议最低入金 1000 美元. 如果您使用美分账户 (Cent Account)，最低 500 美元即可开始运行，并确保有足够保证金应对市场波动。",
  },
  {
...
export const statsData = [
  { icon: TrendingUp, label: "平均胜���", value: "85.3%" },
...
export const testimonials = [
  ...
  {
    quote: "该系统的风控逻辑非常严密，���其是在回撤管理上，体现了极高的专业水平，是长期资产配置的理想选��。",
    author: "Emma Wilson",
    role: "Professional Investor",
  },
  {
    quote: "在近年高波动极端行情中，EA的新闻过滤系统表现完美，成功规避了极端风险，这��稳定性在市面上非常罕见。",
    author: "David Park",
    role: "Senior Trader",
  },
  {
  ...
  {
    quote: "从量化分析的角��看，这款EA的入场逻辑非常精准，能有效过滤市场噪音，资金曲线的���滑度令人惊叹。",
    author: "Ryan Zhang",
