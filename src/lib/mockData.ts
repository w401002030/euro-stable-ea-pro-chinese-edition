...
export const features: {
...
}[] = [
  {
    icon: ShieldCheck,
    title: "极低回撤控制",
    description: "内置多重风控算法，严格限制单笔交易风险，确保账户回撤始终处于可控范围。",
  },
  {
    icon: Zap,
    title: "全自动智��交易",
    description: "基于神经网络算法，24/5 自动识别市场趋���并执行交易，无需人工盯盘。",
  },
  {
    icon: TrendingUp,
    title: "复利增长模���",
    description: "支持动态仓位管理，随账户��额增长自动调整手数，实现资本的指数级增长。",
  },
  {
    icon: Clock,
    title: "专业技术支持",
  ...
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
    description: "自动识别高影响财经数据发布时间，在极端波动行情前自动规避，���护本金安全。",
  },
];
...
export const faqItems = [
  {
    ...
    answer:
      "EA (Expert Advisor) 是一种在 MetaTrader 平台上运行的自动化交易程序���它根据预设的逻辑自动执行买卖操作，消除了情绪干扰，实现 24 小时不间断交易。",
  },
  {
  ...
  {
    question: "我需要一直保持电脑开机吗？",
    answer:
      "是的，EA 需要 MT4 平台持���在线。我们强烈建议使用 VPS (虚拟专用服务器)，它可以让您的交易���境在云端 24/7 稳定运行，不受本地断网或断电影响。",
  },
  {
    question: "安装和设置过程复杂吗？",
    answer:
