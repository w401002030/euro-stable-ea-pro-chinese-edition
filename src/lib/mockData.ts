...
export const features: {
...
}[] = [
  {
    icon: ShieldCheck,
    title: "极低���撤控制",
    description: "内置多重风控���法，严格控制单笔交易风险，确保账户回撤始终处于可控范围。",
  },
  {
    icon: Zap,
    title: "全自动智能交易",
  ...
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
    description: "自动识别���影响财经数据发布时间，在极端波动行情前自动规避，保护本金安全。",
  },
];
...
export const faqItems = [
  {
    ...
    answer:
      "EA (Expert Advisor) 是一种在 MetaTrader 平台上运行的自动化交易程序，它根据预设的逻辑自动执行买卖操���，消除了情绪干扰，实现 24 小时不间断交易。",
  },
  {
...
export const testimonials = [
  ...
  {
    quote: "作��一名投资经理，我一直在寻��可靠的自动化工具。V3Pro 的表现超出了我的预期。",
    author: "Li Wei",
    role: "资产管理经理",
  },
  {
