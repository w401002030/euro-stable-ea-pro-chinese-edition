...
export const features: {
  ...
  },
  {
    icon: Clock,
    title: "专业技术支持",
    description: "���供一对一远程安装指导与策略优化建议，确保每一位用户都能顺利开启交易。",
  },
];
...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "对于标准账户，我们建议最低入金 1000 美元. 如果您使用美分账户 (Cent Account)，最低 100 美元即可开始运行，以确保有足够保证金应对市场波动。",
  },
  {
    question: "我需要一直保持���脑开启吗？",
    answer:
      "是的，EA 需要 MT4 平台持续在线。我们强烈建议使用 VPS (虚拟专用服务器)，它可以让您的交易环境在云端 24/7 ��定运行，不受本地断网或断电影响。",
  },
  {
    question: "安装和设置过程复��吗？",
    answer:
      "非常简单。我们提供详��的中文图文手册和视频教程。通常只需 10-15 分钟即可完成设置。我们的技术���队也提供远程协助服务。",
  },
  {
    question: "购买后是否还有后续续费费用？",
    answer:
      "没有。您购买的是终身授权许可。所有未���的策略优化、参数更新和软件升级均对现有客户免费开放。",
  },
];
...
export const testimonials = [
  {
    quote: "Euro Stable EA 彻���改变了我的投资方式。它的稳定性令人印象深刻，回撤控制得非常好。",
    author: "Alex Johnson",
  ...
  {
    quote: "客���团队非常专业，安装过程很顺利。运行���个月以来，收益非常稳定。",
    author: "Michael Chen",
  ...
  {
    quote: "在多年高波动极端行情���，EA的新闻过滤系统表现完美，成功规避了极端风险，这种稳定性在��面上非常罕见。",
    author: "David Park",
    role: "Senior Trader",
  },
  {
    quote: "刚开始接��外汇非常茫然，感谢技术团队的一对一远程安装���务，非常有耐心，让我这种新手也能轻松上手。",
    author: "Olivia Kim",
  ...
  {
    quote: "这个EA的新闻过滤功能特别��色，避免了多次重大新闻后的损失，值得��赖。",
    author: "Lily Wang",
    role: "Business Owner",
  },
  {
  ...
  {
    quote: "对比其他EA，这个系统的回撤控制确实名不虚传，睡眠也能赚钱的感���真好。",
    author: "Grace Huang",
  ...
  {
    quote: "多品种对冲策略��投资更加安全，资金曲线非常漂���，强烈推荐给朋友。",
