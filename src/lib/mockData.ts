...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "是的，EA 需要 MT4 平台持续在线，我们��提供部署 VPS (虚拟专用服务器) 的教程，它可以让您的交易环境在云端 24/7 稳定运行，不受本地断网或断电影响。",
  },
  {
    question: "安装和设置过程复��吗？",
    answer:
...
export const testimonials = [
  {
    quote: "Euro Stable EA 彻底��变了我的投资方式. 它的稳定性令人印象深刻，回撤控制得非常好。",
    author: "Alex Johnson",
  ...
  {
    quote: "客服团队非常专业，安装过程很顺利。运行两��月以来，收益非常稳定。",
    author: "Michael Chen",
    role: "Forex Enthusiast",
  },
  {
    quote: "该系统的风控逻辑非常严密，特别是在���撤管理上，体现了极高的专业水平，是长期资产配置的理想选择。",
    author: "Emma Wilson",
  ...
  {
    quote: "这个EA的新闻过滤功能特别出色，避免了多次重大新闻后重大损失，值得���赖。",
    author: "Lily Wang",
    role: "Business Owner",
  },
  {
  ...
  {
    quote: "对于其他EA，这个系统的回撤控制���实名不虚传，赚钱的感觉真���。",
    author: "Grace Huang",
