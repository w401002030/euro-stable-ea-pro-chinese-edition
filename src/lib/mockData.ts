...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "对于标准账户，���们建议最低入金 1000 美元。如果您使用美分账户 (Cent Account)，最低 100 美元即可开始运行，以确保有足够的保证金��对市场波动。",
  },
  {
  ...
  },
  {
    question: "安装和设置过程复杂吗？",
    answer:
      "非常简���。我们提供详细的中文图文手册和视频教程。通常只需 10-15 分钟即可完成设置。我们的技术团队也提供远程协助服务。",
  },
  {
...
export const testimonials = [
  ...
  {
    quote: "该系统的风控逻辑非常严��，尤其是在回撤管理上，展现了极高的专业水准，是长期资产配置的理��选择。",
    author: "Liu Ming",
    role: "专业投资人",
  },
  {
    quote: "在多次高波动非���行情中，EA的新闻过滤系统表现完美，成功规避了极��风险，这种稳定性在市面上非常罕见。",
    author: "Sun Li",
    role: "资深交易员",
  },
  {
  ...
  {
    quote: "从量化分析的角度看，这款EA的入场逻辑非常精准，能有效过滤市场噪音，资金曲��的平滑度令人惊叹。",
    author: "Chen Xia",
    role: "机构分析师",
  },
  {
    quote: "这个EA的新闻过滤功能特别出色，避免了多次���大新闻时的损失，值得信赖。",
    author: "陈先生",
    role: "企业主",
  },
  {
  ...
  {
    quote: "对比其���EA，这个系统的回撤控制确实名不虚���，睡眠也能赚钱的感觉真好。",
    author: "赵工程师",
    role: "软件工程师",
  },
  {
  ...
  {
    quote: "多品种对冲策略让投资更加安全，账户曲线非常漂亮，强烈推荐给朋友。",
    author: "周先生",
    role: "金融分析师",
  },
  {
