...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "是的，EA 需要 MT4 平台持续在线。我们强烈建议使用 VPS (虚拟专用服务器)，它可以让您的交易环��在云端 24/7 稳定运行，不受本地断网或断电影响。",
  },
  {
    question: "安装和设置过程复杂吗？",
    answer:
...
export const testimonials = [
  ...
  {
    quote: "刚开始接��外汇非常茫然，感谢技术团队的��对一远程安装服务，非常有耐心，让我这种新手也能轻松上手。",
    author: "Olivia Kim",
  ...
  {
    quote: "对比其他EA，这个系统的回撤控制确实名不虚传，睡眠也能��钱的感觉真好。",
    author: "Grace Huang",
    role: "Software Engineer",
  },
  {
    quote: "V3Pro专业版的VPS赠送服务很贴心，运行一年多，月��收益稳定在15%以上。",
    author: "James Miller",
