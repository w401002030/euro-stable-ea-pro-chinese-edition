...
export const features: {
  ...
  },
  {
    icon: TrendingUp,
    title: "复利增长模式",
    description: "支持动态仓位管理，随账户余额增长自动调整手数，实��复利的指数级增长。",
  },
  {
    icon: BarChart,
    title: "完美适配策略",
  ...
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
    description: "自动识别重大影响财经数据发布时间，在极端波动���情前自动规避，保护本金安全。",
  },
  {
    icon: ShieldCheck,
    title: "超低回撤控制",
  ...
  },
  {
    icon: Clock,
    title: "专业技术支持",
    description: "提供一对一远程安装指���与策略优化建议，确保每一位用户都能顺利开启交易。",
  },
];
...
export const faqItems = [
  {
    question: "MT4是什么���",
    answer:
      "MT4 (MetaTrader 4) 是全球最流行的外汇交易平台，支持 EA 自动交易，提供图表分析、下单管理和一键交易等功��。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "对于标准账户，我们建议最低入金 1000 美元。如果您使用美分账户/美金账户 (Cent/USD Account)，最低 500 美元即可开始运行，并确保��足够保证金应对市场波动。",
  },
  {
    question: "我需要一直保持电��开启吗？",
    answer:
      "是的，EA 需要 MT4 平台持续在线，我们会提供部署 VPS (虚拟专用服务器) 的教程，它可以让您的交易环境在云端 24/7 稳定运行，不受��地断网或断电影响。",
  },
  {
    question: "安装和设置过程复��吗？",
    answer:
      "非常简单。我们提供详细的中文图文手册和视频教程。通常只需 10-15 分钟即可完成设置。我们的技术团队也提供���程协助服务。",
  },
  {
    question: "购买后是否还有后续续费费���？",
    answer:
      "没有。您购买的是终身授权许可。所有未来的策略优化、��数更新和软件升级均对所有客户免费开放。",
  },
];
...
export const statsData = [
  ...
  { icon: Users, label: "���球活跃用户", value: "12,847+" },
];
// Data for testimonials
export const testimonials = [
  {
    quote: "Euro Stable EA 彻底改变了我的投资方式。它的稳定性令人印象深刻，回撤控制���非常好。",
    author: "Alex Johnson",
    role: "Full-time Trader",
  },
  {
    quote: "作为一��投资经理，我一直在寻找可靠的自动化工具。V3Pro 的表现超过了我的预期。",
    author: "Sophia Lee",
    role: "Asset Manager",
  },
  {
  ...
  {
    quote: "该系统的风控逻辑非常严密，特别是在回撤管理上，体现了极高的专业水平，是长期资产配置的理想选择。",
    author: "Emma Wilson",
    role: "Professional Investor",
  },
  {
    quote: "在近一年高波动极端行情下，EA的新闻过滤系统表现完美，成功规避了极端风险，这份稳定性在市面上非常罕见。",
    author: "David Park",
    role: "Senior Trader",
  },
  {
  ...
  {
    quote: "从量化分析的角度看，这���EA的入场逻辑非常精准，能有效过滤市场噪音，资金曲线的光滑度令人惊叹。",
    author: "Ryan Zhang",
    role: "Institutional Analyst",
  },
  {
    quote: "这个EA的新闻过滤功能特别出色，避免了多次重大新闻后重大损失，值得信��。",
    author: "Lily Wang",
    role: "Business Owner",
  },
  {
