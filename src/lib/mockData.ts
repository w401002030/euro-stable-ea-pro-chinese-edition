...
export const features: {
...
}[] = [
  {
    icon: Zap,
    title: "全自动智���交易",
    description: "基于深度神经网络算法，24/7 自动识别市场趋��并执行交易，无需人工盯盘。",
  },
  {
    icon: TrendingUp,
    title: "复利增长模式",
    description: "支持动态仓位管理，随账��余额增长自动调整手数，实现复利的指数级增长。",
  },
  {
    icon: BarChart,
    title: "主流货币��适配",
  ...
  },
  {
    icon: Clock,
    title: "专业技术支持",
    description: "提供一对一远���安装指导与策略优化建议，确保每一位用户都能顺利开启交易。",
  },
];
...
export const faqItems = [
  {
    question: "MT4是什么��",
    answer:
      "MT4 (MetaTrader 4) 是全球最流���的外汇交易平台，支持 EA 自动交易，提供图表分析与下单管理和一键交易等功能。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "是的，EA 需要 MT4 平台持续在线，我们提供部署 VPS (虚拟专用服务器) 的教程，它可以让您的交易环境在云端 24/7 稳定运行，不受���地断网或断电影响。",
  },
  {
    question: "安装和设置过程复��吗？",
    answer:
      "非常简单。我们提供详细的中文图文��册和视频教程。通常只需 10-15 分钟即可完成设置。我们的技术团队也提供���程协助服务。",
  },
  {
...
export const statsData = [
  ...
  { icon: TrendingDown, label: "历史最大���撤", value: "15.2%" },
  { icon: Users, label: "全球活跃用户", value: "12,847+" },
];
// Data for testimonials
export const testimonials = [
  {
    quote: "Euro Stable EA 彻底改变了���的投资方式. 它的稳定性令人印象深刻，回撤控制得非常好。",
    author: "Alex Johnson",
  ...
  {
    quote: "该系统的风控逻辑非常严密，���别是在回撤管理上，体现了极高的专业水平，是长期资产配置的理想选择。",
    author: "Emma Wilson",
    role: "Professional Investor",
  },
  {
    quote: "在过去一年高波动极端行情下，EA的新闻过滤系统表现完美，��功规避了极端风险，这份稳定性在市场上非常出色。",
    author: "David Park",
    role: "Senior Trader",
  },
  {
  ...
  {
    quote: "从量化分析的角度��，这款EA的入场逻辑非常精准，能有效过滤市场噪音，资金曲线的光滑度令人赞叹。",
    author: "Ryan Zhang",
    role: "Institutional Analyst",
  },
  {
    quote: "这个EA的新闻过滤功能特别出色，避免了��次重大新闻后的重大损失，值得信赖。",
    author: "Lily Wang",
    role: "Business Owner",
  },
  {
  ...
  {
    quote: "多品种对冲策略让投资更安心，资金曲线非常��亮，强烈推荐给朋友。",
    author: "Sarah Thompson",
    role: "Financial Analyst",
  },
  {
    quote: "技术团队响应很快，遇到问题都能及时���决。这个EA真正实现了稳定盈利。",
