...
export const faqItems = [
  ...
  {
    question: "我该如何开设交易账户？",
    answer: "您可以选择全球受监管的知名经纪商开设MT4/ECN账户。基本流程包括：在线注册、上传证件进行KYC身份验证、通过电汇或第三方支付入金。为了让EA发挥最佳性能，我们强烈建议选择低点差、低延迟的交易环境。如您在开户过程中遇到困难，请随时联系我们的客服团队，我们将全程协助您完成开户及资金部署。"
  }
];
