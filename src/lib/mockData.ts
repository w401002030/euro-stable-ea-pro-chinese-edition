...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "对于标准账户，我们建议最低入金 1000 美元. 如果您��用美分账户 (Cent Account)，最低 100 美元即可开始运行，以确保���足够保证金应对市场波动。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "��有。您购买的是终身授权许可。所有未来的策略优化、参数更新和软件���级均对现有客户免费开放。",
  },
];
...
export const testimonials = [
  ...
  {
    quote: "客服团队非常专业，安装过程很顺利。运行两个月以来，收益非常���定。",
    author: "Michael Chen",
    role: "Forex Enthusiast",
  },
  {
    quote: "该系统的风控逻辑非常严密，尤其是在回撤管理上，体现了极高���专业水平，是长期资产配置的理想选择。",
    author: "Emma Wilson",
  ...
  {
    quote: "从量化分��的角度看，这款EA的入场逻辑非常精准，能有效过滤市场噪音，资金曲线的光滑度令人惊叹。",
    author: "Ryan Zhang",
