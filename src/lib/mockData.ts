...
export const features: {
  ...
  },
  {
    icon: LifeBuoy,
    title: "智能新闻过滤",
    description: "自动识别重大影响财经数据发布时间，在极端波动行情前自动规避，保��本金安全。",
  },
  {
    icon: ShieldCheck,
    title: "超低回撤控制",
...
export const faqItems = [
  {
    question: "MT4是什么？",
    answer:
      "MT4 (MetaTrader 4) 是全球最流行的外汇交易平台，支持 EA 自动交易，提供图表分析与下��管理和一键交易等功能。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "是的，EA 需要 MT4 平台持续在线，我们提供部署 VPS (虚拟专用服务器) 的教程，它可以让您的交易环境在云端 24/7 ��定运行，不受本地断网或断电影响。",
  },
  {
    question: "安装和设置过程��杂吗？",
    answer:
...
export const testimonials = [
  {
    quote: "Euro Stable EA 彻底���变了我的投资方式. 它的稳定性令人印��深刻，回撤控制得非常好。",
    author: "Alex Johnson",
    role: "Full-time Trader",
  },
  {
    quote: "作��一名投资经理，我一直在寻找可靠的自动化工具。V3Pro 的表���超过了我的预期。",
    author: "Sophia Lee",
    role: "Asset Manager",
  },
  {
  ...
  {
    quote: "V3Pro专业版的运行一年多，��化收益稳定在15%以上。",
    author: "James Miller",
