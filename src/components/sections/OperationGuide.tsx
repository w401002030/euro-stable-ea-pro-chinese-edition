...
const steps = [
  {
    icon: UserPlus,
    title: "1. 准备账户",
    description: "��受监管的经纪商处开设 MT4 交易账户，建议使用 ECN ���低点差账户以获得最佳表现。",
  },
  {
    icon: Download,
    title: "2. 下载软���",
    description: "购买后，您将收到包含 EA 文件、���装手册和预设参数文件的下载链接。",
  },
  {
    icon: Settings,
    title: "3. 加载 EA",
    description: "将 EA 文件放入 MT4 专用目录，加载到指���的货币对图表，并导入我们提供的优化参数。",
  },
  {
    icon: Play,
    title: "4. 开启交易",
