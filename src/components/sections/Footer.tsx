      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <div className="text-center text-sm text-muted-foreground max-w-4xl mx-auto">
            <h3 className="font-bold text-lg md:text-xl lg:text-2xl mb-4 text-foreground text-center">风险免责声明</h3>
            <p className="text-lg md:text-xl lg:text-xl leading-relaxed mt-2 max-w-3xl mx-auto text-foreground">
